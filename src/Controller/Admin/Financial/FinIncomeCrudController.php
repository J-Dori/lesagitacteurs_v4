...
class FinIncomeCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setPageTitle(Crud::PAGE_INDEX, 'Liste des Recettes ' . $this->indexTitle)
            ->setPageTitle(Crud::PAGE_EDIT, '%entity_as_string%')
            ->setPageTitle(Crud::PAGE_NEW, 'Nouveau recette')
    ...
    public function configureActions(Actions $actions): Actions
    {
        ...
        $actions->update(Crud::PAGE_INDEX, Action::NEW,
             fn (Action $action) => $action->setLabel('Créer recette')->addCssClass('btn-success'));
        return $actions;
    }
